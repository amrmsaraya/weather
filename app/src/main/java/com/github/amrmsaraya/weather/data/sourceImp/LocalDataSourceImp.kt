...
class LocalDataSourceImp(private val weatherDao: WeatherDao) : LocalDataSource {
    ...
    override suspend fun getForecast(id: Int): Flow<Forecast> = weatherDao.getForecast(id)

    override suspend fun getCurrentForecast(): Flow<Forecast> = weatherDao.getCurrentForecast()

    override suspend fun getAllForecasts(): Flow<List<Forecast>> = weatherDao.getAllForecasts()
}
